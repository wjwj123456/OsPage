 ...
 * @file
 * @author wuhao
 * @type {{env: {browser: boolean, es6: boolean, amd: boolean, node: boolean}, parserOptions: {ecmaVersion: number, sourceType: string, ecmaFeatures: {jsx: boolean}}, plugins: [*], extends: [*], rules: {comma-dangle: [*], no-cond-assign: string, linebreak-style: [*], quotes: [*], semi: [*], no-console: [*], max-len: [*], object-curly-spacing: [*]}}}
 */
module.exports = {
  "env": {
    "browser": true,
